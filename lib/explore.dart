...
class AppText {
  ...
  static const body  = TextStyle(fontSize: 13, color: AppColors.textSub, height: 1.4);
...
class Destination {
  ...
  const Destination({
    ...
    required this.minCost, required this.midCost, required this.maxCost,
    required this.attractionCount, required this.imagePaths,
  });
}
...
class Experience {
  ...
  const Experience({
    required this.title, required this.author, required this.tags,
    required this.days, required this.attractions,
    required this.cost, required this.upvotes, required this.thumbPath,
  });
}
...
final List<Destination> popularDestinations = [
  Destination(
    ...
    minCost: 2000, midCost: 5000, maxCost: 10000, attractionCount: 56,
    imagePaths: ['images/cox/cox_popular1.jpg', 'images/cox/cox_popular2.jpg', 'images/cox/cox_popular4.jpg', ''],
  ),
  Destination(
    name: "Sylhet",
    description: "Rolling tea gardens, haor wetlands and spiritual shrines of the northeast.",
    tags: ["Nature", "Mountain", "Tea"],
    minCost: 1500, midCost: 4000, maxCost: 8000, attractionCount: 42,
    imagePaths: ['images/sylhet/syl_popular1.jpg', 'images/sylhet/syl_popular2.jpg', 'images/sylhet/syl_popular3.jpg', 'images/sylhet/syl_popular4.jpg'],
  ),
  Destination(
    name: "Bandarban",
    description: "Misty hill tracts with tribal culture, sky-touching peaks and hidden waterfalls.",
    tags: ["Adventure", "Mountain", "Tribal"],
    minCost: 3000, midCost: 6000, maxCost: 12000, attractionCount: 38,
    imagePaths: ['images/bandarban/band_pop1.jpg', 'images/bandarban/band_pop3.jpg', 'images/bandarban/band_pop2.jpg', 'images/bandarban/band_pop4.jpg'],
  ),
  Destination(
    name: "Sundarbans",
    description: "The world's largest mangrove delta — home to Royal Bengal Tiger and river dolphins.",
    tags: ["Nature", "Wildlife", "River"],
    minCost: 4000, midCost: 8000, maxCost: 15000, attractionCount: 29,
    imagePaths: ['images/sundarban/sund_pop1.jpg', 'images/sundarban/sund_pop2.png', 'images/sundarban/sund_pop4.webp', 'images/sundarban/sund_pop3.jpg'],
  ),
];

final List<Experience> trendingExperiences = [
  Experience(
    title: "Cox's Bazar by sadib", author: "sadib",
    tags: ["Beach", "Mountain"],
    days: 2, attractions: 45, cost: 5000, upvotes: 27,
    thumbPath: 'images/cox/cox_trend.jpg',
  ),
  Experience(
    title: "Sylhet Sesh 6 Dine", author: "Rafi",
    tags: ["Nature", "Mountain"],
    days: 6, attractions: 23, cost: 12000, upvotes: 34,
    thumbPath: 'images/sylhet/syl_trend.jpg',
  ),
  Experience(
    title: "Bandarban Trek", author: "Nadia",
    tags: ["Adventure", "Mountain"],
    days: 3, attractions: 18, cost: 7500, upvotes: 51,
    thumbPath: 'images/bandarban/band_trend.jpg',
  ),
  Experience(
    title: "Sundarbans Safari", author: "Tanvir",
    tags: ["Wildlife", "River"],
    days: 4, attractions: 12, cost: 9000, upvotes: 42,
...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  final List<Widget> _pages = const [
    ExplorePage(),
    _PlaceholderPage(label: "Experiences"),  // TODO: replace with ExperiencesPage()
    _PlaceholderPage(label: "Create"),        // TODO: replace with CreatePage()
    _PlaceholderPage(label: "Profile"),       // TODO: replace with ProfilePage()
  ];
...
class _BottomNavBar extends StatelessWidget {
  ...
  static const _items = [
    ...
    (icon: Icons.map_outlined,       activeIcon: Icons.map_rounded,          label: "Experiences"),
    (icon: Icons.add_circle_outline, activeIcon: Icons.add_circle_rounded,   label: "Create"),
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(active ? item.activeIcon : item.icon,
                          color: active ? AppColors.primary : AppColors.textSub, size: 22),
...
class _PlaceholderPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
    child: Text(label, style: const TextStyle(color: Colors.white54, fontSize: 18)),
  );
}
...
class _ExplorePageState extends State<ExplorePage> {
    ...
    child: Padding(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text("GHURTEJAI",
              style: AppText.label.copyWith(color: AppColors.primary, letterSpacing: 2.5)),
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: _searchFocused
                ? (_aiMode ? AppColors.aiGlow : AppColors.primary).withValues(alpha: 0.6)
                : AppColors.border,
            width: 1.5,
          ),
          boxShadow: _searchFocused ? [BoxShadow(
            color: (_aiMode ? AppColors.aiGlow : AppColors.primary).withValues(alpha: 0.12),
            blurRadius: 20, spreadRadius: 2,
          )] : [],
        ),
        child: Row(children: [
          const SizedBox(width: 16),
          Icon(_aiMode ? Icons.auto_awesome_rounded : Icons.search_rounded,
              color: _aiMode ? AppColors.aiGlow : AppColors.textSub, size: 20),
          ...
          GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: _aiMode ? AppColors.aiGlow.withOpacity(0.5) : Colors.transparent),
              ),
              child: Row(children: [
      ...
      child: !_aiMode
          ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              _suggestionSection("Recent Searches", Icons.history_rounded, [
                "Cox's Bazar", "Bumba experience", "Sylhet tea garden",
              ]),
              const SizedBox(height: 16),
              _suggestionSection("Popular Searches", Icons.trending_up_rounded, [
                "Beach destinations", "Mountain trek", "Under ৳5k experiences",
              ]),
            ])
          : _aiSuggestions(),
    ),
  ...
  Widget _suggestionSection(String title, IconData icon, List<String> items) =>
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ...items.map((s) => ListTile(
          ...
          title: Text(s, style: AppText.body.copyWith(color: AppColors.textPrimary)),
  ...
  Widget _aiSuggestions() => Column(
    ...
    children: [
      Row(children: [
        const Icon(Icons.auto_awesome_rounded, size: 13, color: AppColors.aiGlow),
        const SizedBox(width: 6),
        Text("Try asking", style: AppText.label.copyWith(color: AppColors.aiGlow)),
      ]),
      ...
      ...[
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: AppColors.aiSoft, borderRadius: BorderRadius.circular(10),
            border: Border.all(color: AppColors.aiGlow.withOpacity(0.2)),
          ),
          child: Text(q, style: AppText.body.copyWith(
  ...
  Widget _buildPopularDestinations() => const SliverToBoxAdapter(
    child: _PopularDestCarousel(),
  );
        ...
        itemBuilder: (ctx, i) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Text(tag, style: AppText.chip.copyWith(
...
class _DestPageCard extends StatelessWidget {
        ...
        child: Column(children: [
          ...
          Expanded(
            child: Row(children: [
              Expanded(
                flex: 5,
                child: _AssetImg(path: dest.imagePaths[0]),
              ),
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Expanded(child: Text(dest.name,
                    style: AppText.title, overflow: TextOverflow.ellipsis)),
                ...dest.tags.take(2).map((t) => Container(
                  ...
                  child: Text(t, style: AppText.label.copyWith(
              ...
              Row(children: [
                ...
                _divider(),
                const Icon(Icons.place_outlined, size: 12, color: AppColors.green),
                const SizedBox(width: 3),
                Text("${dest.attractionCount} attractions",
                    style: AppText.label.copyWith(color: AppColors.green, fontSize: 10)),
              ]),
            ]),
          ),
        ]),
  ...
  Widget _cTier(String t) =>
      Text(t, style: AppText.label.copyWith(color: AppColors.textSub, fontSize: 11));
  Widget _divider() => Padding(
    padding: const EdgeInsets.symmetric(horizontal: 5),
    child: Text("|", style: AppText.label.copyWith(color: AppColors.border, fontSize: 13)),
  );
...
class _TrendingExpCard extends StatelessWidget {
        ...
        child: Stack(fit: StackFit.expand, children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Wrap(spacing: 4, children: exp.tags.map((t) => Container(
                ...
                Row(children: [
                  ...
                  const SizedBox(width: 10),
                  _stat(Icons.place_outlined, "${exp.attractions} attractions"),
                ]),
                const SizedBox(height: 6),
                Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      const SizedBox(width: 3),
                      Text("${exp.upvotes}", style: AppText.label.copyWith(
  ...
  Widget _stat(IconData icon, String val) => Row(children: [
    Icon(icon, size: 11, color: Colors.white54),
    const SizedBox(width: 3),
    Text(val, style: AppText.label.copyWith(color: Colors.white54, fontSize: 10)),
  ]);
  String _k(int v) => v >= 1000 ? "${(v / 1000).toStringAsFixed(0)}k" : "$v";
}
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 6),
              Row(children: [
                const Icon(Icons.place_outlined, size: 10, color: AppColors.green),
                const SizedBox(width: 2),
                Text("${dest.attractionCount} attractions",
                    style: AppText.label.copyWith(color: AppColors.green, fontSize: 9)),
                const Spacer(),
                Text("৳${_k(dest.minCost)}+",
                    style: AppText.label.copyWith(color: AppColors.primary, fontSize: 9)),
              ]),
            ]),
          ),
        ]),
  ...
  Widget build(BuildContext context) {
    if (path.isEmpty) {
      ...
      return Container(
        ...
        child: const Center(
          child: Icon(Icons.image_outlined, color: AppColors.textMuted, size: 18),
        ),
      );
    }
    return Image.asset(
